...
> [!WARNING]
> Swarm is intended to explore ergonomic interfaces for multi-agent systems. This version is intended to be used in production, and will have official support.
>
> The primary goal of Swarm is to showcase the handoff & routines patterns explored in the [Orchestrating Agents: Handoffs & Routines](https://cookbook.openai.com/examples/orchestrating_agents) cookbook. It is not meant as a standalone library, and is primarily for educational and production purposes.
...
```shell
pip install git+ssh://git@github.com/simulanics/swarm.git
```

or

```shell
pip install git+https://github.com/simulanics/swarm.git
```
